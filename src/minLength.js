 ...
 * (may it be an array or a string) is major of equals the given number.
 * @param max
 * @param error
 * @returns {function({length: *}): boolean}
 */
const minLength = (max, error = `The provided value's length bigger than ${max}`) => createValidator(
